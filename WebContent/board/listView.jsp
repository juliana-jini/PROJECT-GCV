...
<ul id="main">
<div id="total">총 <c:out value="${pagelist.totalCount }"/>건</div>
	<li class="trow">
		<ul class="row">
			<li>번호</li>
			<li>제목</li>
...
<div style="width: 900px; margin: auto; text-align: center;">
	...
	<c:if test="${user != null }"> <a href="insertView.jsp?page=${page }" class="button" >작성하기</a></c:if>
...
<script type="text/javascript">
	...
	pnums.forEach(function(item){
		...
		if(item.innerHTML=='${page}') {
			item.style.color = 'rgb(31, 126, 249)';
